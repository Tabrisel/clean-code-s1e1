...
var addButton=document.querySelector(".tasks__btn_add");//add button
...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="tasks__input tasks__input_edit";
...
var editTask=function(){
  ...
  var editInput=listItem.querySelector(".tasks__input_edit");
